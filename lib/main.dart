...
import 'package:sleepwell_app/presentation/screens/screen_packages/screen_packages.dart';
...
import 'package:sleepwell_app/presentation/screens/screen_wearable/screen_wearable.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/screen_wearable': (context) => const ScreenWearable(),
        '/screen_packages': (context) => const ScreenPackages()
      },
    );
  }
}
